...
with open(os.path.join(".", "src", "fman", "meta.py"), "r") as handle_meta:
...
setup(
    name="fman",
    version=VERSION,
    description="A simple file manager to find/ delete duplicate files.",
    author="Usman Zubair",
    ...
    python_requires=">=3",
    entry_points={"console_scripts": ["fman=fman.cmd:main"]},
    classifiers=[
